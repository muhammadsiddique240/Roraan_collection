...
export function CategoryBento() {
  return (
    <section className="pt-8 pb-16 md:pt-12 md:pb-24 max-w-[1600px] mx-auto px-6 lg:px-12 w-full bg-white">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
        ...
        >
          ...
          <Link to="/shop?category=men" className="absolute inset-0 flex items-center justify-center z-10 cursor-pointer">
            <h2 className="text-white text-5xl md:text-7xl font-extrabold uppercase tracking-widest drop-shadow-sm">
              MEN
            </h2>
          </Link>
        </motion.div>
